...
VkCommandBuffer RendererContext::GetCommandBuffer() const
{
...
VkDescriptorPool RendererContext::GetDescriptorPool() const
{
...
{
    if(!glfwCreateWindowSurface(m_VulkanInstance, &InWindow, nullptr, &m_Surface))
    {
        return /*error*/;
    }
}
...
VkPipelineLayout RendererContext::GetPipelineLayout() const
{
...
VKAPI_ATTR VkBool32 VKAPI_CALL RendererContext::ValidationMessageCallback(VkDebugUtilsMessageSeverityFlagBitsEXT      InMessageSeverity,
