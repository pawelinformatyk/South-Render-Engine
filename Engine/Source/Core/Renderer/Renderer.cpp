...
//         {static_cast<const void*>(QuadVertices.data()), static_cast<uint32_t>(sizeof(Vertex)),
//         static_cast<uint32_t>(QuadVertices.size())}, {static_cast<const void*>(QuadIndices.data()),
//         static_cast<uint32_t>(sizeof(uint32_t)), static_cast<uint32_t>(QuadIndices.size())});
//
